...
import shap
import xgboost as xgb  # Replace LightGBM with XGBoost
...
# Define XGBoost model with hyperparameters and perform Grid Search
params = {
    'max_depth': [3, 6],
...
grid = GridSearchCV(estimator=xgb.XGBClassifier(objective='binary:logistic', use_label_encoder=False, eval_metric='logloss'), param_grid=params, cv=3, scoring='f1')
